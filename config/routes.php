...
$router->group(['prefix' => '/api'], function ($router) {
    ...
    $router->get('/cron/videocall-email-test', [WebhookController::class, 'videocallEmailTest'], [], 'api.cron.videocall_email_test');
...
$router->group(['prefix' => '/admin', 'middleware' => [AuthMiddleware::class, AdminMiddleware::class]], function ($router) {
    ...
    $router->post('/transfers/veiculos/{id}/excluir', [AdminTransfersController::class, 'deleteVehicle'], [CsrfMiddleware::class], 'admin.transfers.vehicles.delete');
    ...
    $router->post('/afiliados/comissoes/{id}/cancelar', [AdminAffiliatesController::class, 'cancelCommission'], [CsrfMiddleware::class], 'admin.affiliates.cancel');
