...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .error-badge { display: inline-block; padding: 6px 16px; background: rgba(228,181,5,0.15); border: 1px solid rgba(228,181,5,0.3); border-radius: 20px; font-size: 11px; font-weight: 600; color: #E4B505; letter-spacing: 1px; text-transform: uppercase; margin-bottom: 20px; }
        ...
        .error-palm { font-size: 48px; margin-bottom: 20px; opacity: 0.8; }
        ...
        .btn-home { display: inline-flex; align-items: center; gap: 8px; padding: 14px 28px; background: #1B6F00; color: #fff; border-radius: 10px; font-size: 14px; font-weight: 600; text-decoration: none; transition: all .2s; margin-bottom: 28px; box-shadow: 0 4px 12px rgba(27,111,0,0.2); }
        .btn-home:hover { background: #155c00; transform: translateY(-1px); box-shadow: 0 6px 16px rgba(27,111,0,0.3); }
        .search-box { display: flex; align-items: center; gap: 10px; border: 1.5px solid #e0e0e0; border-radius: 10px; padding: 12px 16px; margin-bottom: 28px; max-width: 340px; transition: border-color .2s; }
        .search-box:focus-within { border-color: #1B6F00; }
        .search-box svg { flex-shrink: 0; color: #999; }
        .search-box:focus-within svg { color: #1B6F00; }
        .search-box input { flex: 1; border: none; outline: none; font-size: 14px; font-family: 'Poppins', sans-serif; color: #1C2011; }
...
<body>
    <div class="error-container">
        <div class="error-left">
            ...
            <div class="error-palm">&#127796;</div>
            <div class="error-number">404</div>
            <p class="error-quote">"O verdadeiro objetivo da viagem não é chegar ao destino, mas desfrutar do caminho."</p>
        </div>
        <div class="error-right">
            <h1>Página não encontrada</h1>
            <p>Parece que você se perdeu no paraíso! A página que tentou acessar não existe ou foi movida.</p>
            <a href="/" class="btn-home">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M3 9l9-7 9 7v11a2 2 0 01-2 2H5a2 2 0 01-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg>
                Voltar para o início
            </a>
            <form action="/pesquisa" method="GET" class="search-box">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="11" cy="11" r="8"/><line x1="21" y1="21" x2="16.65" y2="16.65"/></svg>
                <input type="text" name="q" placeholder="Buscar passeios, destinos...">
            </form>
