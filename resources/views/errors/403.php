...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .btn-login { display: inline-flex; align-items: center; gap: 8px; padding: 14px 28px; background: #fff; color: #1C2011; border: 1.5px solid #e0e0e0; border-radius: 10px; font-size: 14px; font-weight: 600; text-decoration: none; transition: all .2s; margin-bottom: 28px; }
...
<body>
    <div class="error-container">
        <div class="error-left">
            <span class="error-badge">Restrito</span>
            <div class="error-icon">&#128274;</div>
            <div class="error-number">403</div>
            <p class="error-quote">"Algumas praias são privativas, mas há muitas outras para explorar."</p>
        </div>
