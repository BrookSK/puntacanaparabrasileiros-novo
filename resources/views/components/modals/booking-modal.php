    ...
    <div class="booking-modal">
        ...
        <div class="booking-modal-layout">
            ...
            <div class="booking-modal-main">
                ...
                <!-- Step 1: Seleção de Hotel e Horário de Pickup -->
                <div class="bm-step active" id="bmStep1">
                    <div class="bm-hotel-section">
                        <h4 class="bm-section-title">Selecione seu Hotel</h4>
                        <p class="bm-section-subtitle">Pesquise o hotel onde você está hospedado para verificar horários de pickup disponíveis</p>
                        ...
                        <div class="bm-hotel-list" id="bmHotelList">
                            <div class="bm-hotel-loading" id="bmHotelLoading">
                                <span>Carregando hotéis disponíveis...</span>
                            </div>
                        </div>
                    </div>

                    <!-- Horários de Pickup (aparece após selecionar hotel) -->
                    <div class="bm-pickup-section" id="bmPickupSection" style="display:none">
                        <h4 class="bm-section-title">Horário de Pickup</h4>
