            ...
            <div class="booking-modal-main">
                ...
                <div class="bm-step active" id="bmStep1">
                    <div class="bm-hotel-section">
                        ...
                        <p class="bm-section-subtitle">Pesquise o hotel onde você está hospedado</p>

                        <div class="bm-hotel-search">
                            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="8"/><line x1="21" y1="21" x2="16.65" y2="16.65"/></svg>
                            <input type="text" id="bmHotelSearch" placeholder="Digite o nome do hotel..." autocomplete="off">
                        </div>
