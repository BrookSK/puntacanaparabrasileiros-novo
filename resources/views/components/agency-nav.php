...
.aff-card-header{display:flex;align-items:center;gap:10px;margin-bottom:10px}
.aff-card--tip{background:#fffef5;border-color:#fde68a}
.aff-tips-list{list-style:none;padding:0;margin:0}
...
.aff-empty-state{text-align:center;padding:40px 20px;grid-column:1/-1}
...
<aside class="aff-sidebar">
    ...
    <nav class="aff-nav">
        ...
        <a href="/painel-agencia/visitas" class="aff-nav-link <?= ($active ?? '') === 'visitas' ? 'active' : '' ?>">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"/><circle cx="12" cy="12" r="3"/></svg>
            <span>Visitas</span>
        </a>
        <a href="/painel-agencia/criativos" class="aff-nav-link <?= ($active ?? '') === 'criativos' ? 'active' : '' ?>">
        ...
        <a href="/painel-agencia/landing-page" class="aff-nav-link <?= ($active ?? '') === 'landing' ? 'active' : '' ?>">
