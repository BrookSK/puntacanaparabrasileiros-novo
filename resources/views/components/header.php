    ...
    <div class="container">
        <div class="header-inner">
            ...
            <nav class="main-nav" id="mainNav">
                ...
                <a href="/contato" class="nav-link <?= str_starts_with($_SERVER['REQUEST_URI'] ?? '', '/contato') ? 'active' : '' ?>">Contato</a>
            </nav>
                    ...
                    <a href="<?= current_user() ? '/minha-conta/wishlist' : '/login' ?>" class="header-icon-btn" title="Lista de Desejos">
                        ...
                        <?php
                            ...
                            if (current_user()) {
                                ...
                                $wishlistCount = $wishlistModel->countByUser((int) current_user()['id']);
                            }
                        ?>
                        <span class="cart-badge" id="wishlistBadge" style="<?= $wishlistCount > 0 ? '' : 'display:none;' ?>"><?= $wishlistCount ?></span>
                    </a>
                </div>
