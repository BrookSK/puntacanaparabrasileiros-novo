<section class="aff-panel">
    <div class="container">
        <div class="aff-layout">
            <?= partial('agency-nav', ['agency' => $agency, 'active' => 'criativos']) ?>

            <main class="aff-main">
                <div class="aff-page-header">
                    <div>
                        <h1 class="aff-page-title">Criativos</h1>
                        <p class="aff-page-subtitle">Materiais para divulgar os passeios de Punta Cana</p>
                    </div>
                </div>

                <div class="aff-card">
                    <div class="aff-card-header">
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#1B6F00" stroke-width="2"><rect x="3" y="3" width="18" height="18" rx="2"/><circle cx="8.5" cy="8.5" r="1.5"/><polyline points="21 15 16 10 5 21"/></svg>
                        <h3 class="aff-card-title">Materiais Disponíveis</h3>
                    </div>
                    <p class="aff-card-desc">Baixe estes materiais para divulgar os passeios. Use o botão "Copiar Link" para compartilhar junto com seu link de indicação.</p>
                    ...
                    <div class="aff-creatives-grid">
                            ...
                            <div class="aff-creative-card">
                                ...
                                <div class="aff-creative-info">
                                    ...
                                    <div class="aff-creative-actions">
                                        ...
                                        <button type="button" class="btn btn-sm btn-outline" onclick="copyAgCreativeLink(this)" data-url="<?= e($refLink) ?>">Copiar Link</button>
                                    </div>
                                </div>
                            </div>
                            <?php endforeach; ?>
                        <?php else: ?>
                            <div class="aff-empty-state">
                                ...
                                <span>Enquanto isso, use seu link de indicação para divulgar os passeios.</span>
                            </div>
                        <?php endif; ?>
                    </div>
                </div>
...
<script>
function copyAgCreativeLink(btn) {
