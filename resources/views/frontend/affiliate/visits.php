            ...
            <main class="aff-main">
                ...
                <div class="aff-card">
                    ...
                    <?php
                        ...
                        $tp = (int)$totalPages;
                        $window = 2; // quantas páginas mostrar de cada lado da atual
                    ...
                    <nav class="pagination" style="margin-top:20px;display:flex;flex-wrap:wrap;gap:6px;align-items:center;">
                        <?php if ($cur > 1): ?>
                            <a href="?page=<?= $cur - 1 ?>" class="page-link">&laquo;</a>
                        <?php endif; ?>

                        <?php if ($start > 1): ?>
                            <a href="?page=1" class="page-link <?= $cur === 1 ? 'active' : '' ?>">1</a>
                        ...
                        <?php if ($end < $tp): ?>
                            ...
                            <a href="?page=<?= $tp ?>" class="page-link <?= $cur === $tp ? 'active' : '' ?>"><?= $tp ?></a>
                        <?php endif; ?>

                        <?php if ($cur < $tp): ?>
                            <a href="?page=<?= $cur + 1 ?>" class="page-link">&raquo;</a>
                        <?php endif; ?>
                    </nav>
                    <?php endif; ?>
                </div>
