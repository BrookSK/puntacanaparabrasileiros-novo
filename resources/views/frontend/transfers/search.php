        ...
        <div class="transfers-home-grid">
            ...
            <?php else: ?>
                <div class="transfer-home-card">
                    ...
                    <p class="transfer-home-desc">Viaje com <strong>conforto e economia</strong> em um <strong>ônibus climatizado</strong>, com embarques regulares e motoristas experientes. Ideal para quem busca <strong>praticidade em Punta Cana</strong>.</p>
                </div>
                <div class="transfer-home-card">
                    <div class="transfer-home-img">
                    ...
                    <p class="transfer-home-desc">Tenha <strong>mais conforto e privacidade</strong> com nosso transfer exclusivo em van. Perfeito para famílias ou pequenos grupos, com <strong>ar-condicionado</strong> e <strong>horários flexíveis</strong>.</p>
                </div>
                <div class="transfer-home-card">
                    <div class="transfer-home-img">
                    ...
                    <p class="transfer-home-desc">Viaje com <strong>segurança e acessibilidade</strong> em nossa van adaptada com <strong>rampa para cadeirantes</strong>. Espaço amplo e motorista preparado para um <strong>trajeto tranquilo</strong>.</p>
                </div>
            <?php endif; ?>
        </div>
    </div>
