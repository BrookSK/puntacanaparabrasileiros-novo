                        ...
                        <div class="payment-methods">
                            ...
                            <label class="payment-option <?= $gw['id'] === ($gateways[0]['id'] ?? '') ? 'active' : '' ?>">
                                ...
                                <div class="payment-option-icon">
                                    ...
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"><path d="M9.2 18.5L4.5 13.8c-.7-.7-.7-1.8 0-2.5L9.2 6.5c.3-.3.8-.3 1.1 0l1.7 1.7-2.8 2.8c-.7.7-.7 1.8 0 2.5l2.8 2.8-1.7 1.7c-.3.3-.8.3-1.1-.5z" fill="#32BCAD"/><path d="M14.8 18.5l4.7-4.7c.7-.7.7-1.8 0-2.5L14.8 6.5c-.3-.3-.8-.3-1.1 0l-1.7 1.7 2.8 2.8c.7.7.7 1.8 0 2.5l-2.8 2.8 1.7 1.7c.3.3.8.3 1.1-.5z" fill="#32BCAD"/></svg>
                                    <?php endif; ?>
                                </div>
