...
<section class="section section-instagram">
    <div class="container">
        ...
        <!-- Link para ver mais no Instagram -->
        <div class="instagram-see-more">
            <a href="https://www.instagram.com/<?= e($instagramUsername ?? 'puntacanaparabrasileiros') ?>" target="_blank" rel="noopener" class="instagram-see-more-btn">
