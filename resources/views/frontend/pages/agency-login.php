...
<section class="passeios-hero">
    <div class="container">
        <div class="passeios-hero-content">
            <h1>Acesse o Painel da sua Agência</h1>
            <p>Bem-vindo de volta! Faça login para acessar o painel da sua agência parceira, acompanhar suas vendas, comissões e o link de indicação exclusivo.</p>
        </div>
    </div>
</section>
    ...
    <div class="container">
        <div class="affiliate-register-card">
            ...
            <div style="text-align:center;margin-top:24px;padding-top:20px;border-top:1px solid #f0f0f0">
                <p style="font-size:14px;color:var(--gray)">Ainda não é uma agência parceira?</p>
                <a href="/cadastro-agencia" class="btn btn-secondary" style="margin-top:10px">Cadastre sua Agência &rarr;</a>
            </div>
        </div>
    </div>
</section>
