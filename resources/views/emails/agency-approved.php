<div style="max-width:600px;margin:0 auto;font-family:'Segoe UI',Arial,sans-serif;color:#1a1a1a;">
    <div style="background:#f0fdf4;padding:30px;text-align:center;border-radius:10px 10px 0 0;border-bottom:2px solid #1B6F00;">
        ...
        <h1 style="color:#1C2011;font-size:22px;margin:0;">Sua agência foi aprovada!</h1>
    </div>
    <div style="background:#fff;padding:30px 40px;border:1px solid #e5e7eb;border-top:none;">
        ...
        <p style="font-size:14px;color:#555;line-height:1.7;margin-bottom:24px;">
            Temos uma ótima notícia! A agência <strong><?= e($companyName ?? '') ?></strong> agora é uma <strong style="color:#1B6F00;">parceira aprovada</strong> da Punta Cana para Brasileiros.
        </p>
        ...
        <div style="text-align:center;margin-bottom:24px;">
            <a href="<?= e($siteUrl ?? 'https://puntacananovo.lrvweb.com.br') ?>/login-agencia" style="display:inline-block;padding:12px 28px;background:#1B6F00;color:#fff;border-radius:6px;font-size:14px;font-weight:600;text-decoration:none;">Acessar Painel da Agência</a>
        </div>
