<div style="max-width:600px;margin:0 auto;font-family:'Segoe UI',Arial,sans-serif;color:#1a1a1a;">
    ...
    <div style="background:#f0fdf4;padding:30px;text-align:center;border-radius:10px 10px 0 0;border-bottom:2px solid #1B6F00;">
        ...
        <h1 style="color:#1C2011;font-size:22px;margin:0;">Recebemos sua solicitação!</h1>
    </div>
    ...
    <div style="background:#fff;padding:30px 40px;border:1px solid #e5e7eb;border-top:none;">
        ...
        <p style="font-size:14px;color:#555;line-height:1.7;margin-bottom:24px;">
            Recebemos a solicitação da agência <strong><?= e($companyName ?? '') ?></strong> para se tornar parceira da <strong>Punta Cana para Brasileiros</strong>. Que bom ter você com a gente!
        </p>
        ...
        <p style="font-size:14px;color:#555;line-height:1.7;margin-bottom:24px;">
            Assim que sua parceria for aprovada, avisaremos por e-mail e WhatsApp com as instruções de acesso.
        </p>
    ...
    <div style="background:#f8f8f8;padding:20px 40px;text-align:center;border:1px solid #e5e7eb;border-top:none;border-radius:0 0 10px 10px;">
        ...
        <p style="font-size:11px;color:#aaa;margin:10px 0 0;">Você recebeu este e-mail porque solicitou uma parceria de agência.</p>
    </div>
</div>
