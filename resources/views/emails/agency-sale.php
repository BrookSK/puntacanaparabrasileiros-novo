<div style="max-width:600px;margin:0 auto;font-family:'Segoe UI',Arial,sans-serif;color:#1a1a1a;">
    ...
    <div style="background:#fff;padding:30px 40px;border:1px solid #e5e7eb;border-top:none;">
        ...
        <div style="background:#f0fdf4;border:1px solid #bbf7d0;border-radius:8px;padding:20px;margin-bottom:24px;">
            <h3 style="font-size:14px;margin:0 0 12px;color:#1B6F00;text-transform:uppercase;letter-spacing:0.5px;">Detalhes da venda</h3>
            <table style="width:100%;font-size:14px;">
                <?php if (!empty($bookingNumber)): ?>
                <tr><td style="padding:6px 0;color:#333;"><strong>Reserva:</strong> <?= e($bookingNumber) ?></td></tr>
                <?php endif; ?>
                <tr><td style="padding:6px 0;color:#333;"><strong>Valor da venda:</strong> <?= e($saleAmount ?? '') ?></td></tr>
                <tr><td style="padding:6px 0;color:#1B6F00;font-size:16px;"><strong>Sua comissão:</strong> <?= e($commissionAmount ?? '') ?></td></tr>
            </table>
        </div>
