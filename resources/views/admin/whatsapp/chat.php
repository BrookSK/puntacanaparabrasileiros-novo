...
<div class="wpp-chat-wrapper" id="chatApp"
    ...
    <aside class="wpp-details" id="wppDetails" style="display:none;">
        ...
        <div class="wpp-details-body">
            ...
            <button class="btn btn-outline btn-block" style="margin-top:8px;" onclick="discussWithTeam()"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M17 8h2a2 2 0 012 2v10l-4-4H9a2 2 0 01-2-2v-1"/><path d="M15 2H3a2 2 0 00-2 2v9l4-4h10a2 2 0 002-2V4a2 2 0 00-2-2z"/></svg> Discutir com a equipe</button>
