...
<div class="card-header">
    ...
    <a href="/admin/horarios/<?= (int) $trip['id'] ?>" class="btn btn-back">
        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="15 18 9 12 15 6"/></svg>
        Voltar para <?= e($trip['title']) ?>
    </a>
</div>

<form method="POST" action="<?= $isEdit ? "/admin/horarios/{$trip['id']}/hotel/{$hotel['id']}/editar" : "/admin/horarios/{$trip['id']}/hotel/criar" ?>" class="admin-form" style="max-width:720px;">
    <?= csrf_field() ?>
        ...
        <div class="form-row">
            <div class="form-group col-6">
                ...
                <input type="number" 
                       ...
                       class="form-control" 
                       min="0">
                <small style="font-size:11px;color:#94a3b8;">Menor número = aparece primeiro</small>
            </div>
            <?php if ($isEdit): ?>
            <div class="form-group col-6">
                <label>Status</label>
    ...
    <div class="admin-card">
        <div class="admin-card-header">
            ...
            <div>
                ...
                <p class="admin-card-subtitle">Horários disponíveis para buscar no hotel</p>
            </div>
        </div>
