            ...
            <div class="booking-vouchers-list">
                ...
                <div class="booking-voucher-item">
                    ...
                    <div class="booking-voucher-item-actions">
                        ...
                        <a href="/admin/vouchers/<?= (int)$vc['id'] ?>/visualizar" target="_blank" class="btn btn-sm btn-outline" title="Visualizar Voucher">
                            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"/><circle cx="12" cy="12" r="3"/></svg>
                            Ver Voucher
                        </a>
                        <a href="/admin/vouchers/<?= (int)$vc['id'] ?>/download" target="_blank" class="btn btn-sm btn-outline" title="Baixar PDF">
